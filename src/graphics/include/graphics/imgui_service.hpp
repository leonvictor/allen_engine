...
class ImGUIService : public IService
{
  public:
    void Initialize(ServiceProvider* pProvider) override
    {
        ...
        colors[ImGuiCol_Border] = ImVec4(0.02f, 0.02f, 0.02f, 0.50f);
        ...
        colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
        ...
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.19f, 0.19f, 0.19f, 1.00f);
        ...
        colors[ImGuiCol_SeparatorHovered] = ImVec4(0.13f, 0.14f, 0.14f, 1.00f);
        colors[ImGuiCol_SeparatorActive] = ImVec4(0.57f, 0.57f, 0.57f, 1.00f);
        colors[ImGuiCol_ResizeGrip] = ImVec4(0.27f, 0.27f, 0.27f, 1.00f);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.09f, 0.09f, 0.09f, 0.67f);
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.57f, 0.57f, 0.57f, 0.95f);
        colors[ImGuiCol_Tab] = ImVec4(0.03f, 0.03f, 0.03f, 0.86f);
        ...
        colors[ImGuiCol_DockingPreview] = ImVec4(0.39f, 0.39f, 0.40f, 0.69f);
        ...
        colors[ImGuiCol_TextSelectedBg] = ImVec4(0.26f, 0.29f, 0.36f, 0.35f);
