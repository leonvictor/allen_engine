#include "asset_loaders/animation_loader.hpp"
...
namespace aln
{
bool AnimationLoader::Load(AssetRequestContext& ctx, AssetRecord* pRecord, BinaryMemoryArchive& archive)
{
...
void AnimationLoader::InstallDependencies(AssetRecord* pAssetRecord, const Vector<IAssetHandle>& dependencies)
{
