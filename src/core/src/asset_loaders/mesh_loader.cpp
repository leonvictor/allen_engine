#include "asset_loaders/mesh_loader.hpp"
...
namespace aln
{
bool MeshLoader::Load(AssetRequestContext& ctx, AssetRecord* pRecord, BinaryMemoryArchive& archive)
{
...
void MeshLoader::Unload(AssetRecord* pRecord)
{
...
void MeshLoader::InstallDependencies(AssetRecord* pAssetRecord, const Vector<IAssetHandle>& dependencies)
{
