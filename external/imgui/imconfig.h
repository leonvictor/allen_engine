...
#define IM_VEC2_CLASS_EXTRA                                                 \
        ImVec2(const aln::Vec2& f) { x = f.x; y = f.y; }                    \
        operator aln::Vec2() const { return aln::Vec2(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                 \
        ImVec4(const aln::Vec4& f) { x = f.x; y = f.y; z = f.z; w = f.w; }  \
        operator aln::Vec4() const { return aln::Vec4(x,y,z,w); }
